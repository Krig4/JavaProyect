...
public class Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "login":
			...
			break;
		case "verentrenos":
			mostrarEntrenos(request, response, session);
			break;
		case "crearentreno":
			crearEntreno(request, response, session);
			break;
		case "crearusuario":
		...
		case "crearejercicio":
			...
			break;
		case "exportar":
			exportarEntrenos(request, response, session);
			break;
		default:
	...
	private void exportarEntrenos(HttpServletRequest request, HttpServletResponse response, HttpSession session) {
	...
	private void crearEntreno(HttpServletRequest request, HttpServletResponse response, HttpSession session) {
		//Recuperar los parametros ejercicio_x y observaciones_x
	...
	private void mostrarEntrenos(HttpServletRequest request, HttpServletResponse response, HttpSession session) {
		String usuario = (String) session.getAttribute("usuario");
		ArrayList<Entrenamiento> lista_entrenos=AccesoDatos.recuperarEntrenos(usuario);
	...
	private void gestionarLogin(HttpServletRequest request, HttpServletResponse response, HttpSession session) throws ServletException, IOException {
		...
		if (rol==null)
		{
			//Podramos meter un atributo de "usuario no encontrado"
