...
public class Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(accion != null)
        {
            ...
            {
                ArrayList<Contacto> agenda = AccesoDatos.recuperarContactos();
            ...
            }else if (accion.equals("buscar")) 
            {
                 ...
                 ArrayList<Contacto> contactosEncontrados = AccesoDatos.buscarContactos(nombreBuscado);
            ...
            }else if(accion.equals("borrar")) 
            {
                ...
                AccesoDatos.borrarContacto(tlf);
                ArrayList<Contacto> lista = AccesoDatos.recuperarContactos();
